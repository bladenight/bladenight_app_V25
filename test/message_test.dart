...
class MessageTest {
  void main() async {
    ...
    MessagesDb.addMessage(ExternalAppMessage(
        uid: UUID.createUuid(),
        body:
            'huiahusdauhushdfoiehrwfuidsahöfaisjdfapoiöhgsfögniisdhgiojfgoöfsdijgofisdhgnjfjiisdfhgsifhgusdhfgiulsdhfsghdfguihsdfguihusdfhusdföjirsjfgiöofgjnsifdngisjfkjfiajfiöosjsdlh',
