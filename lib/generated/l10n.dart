...
class Localize {
  ...
  /// `BladeNight on`
  String get eventOn {
    return Intl.message('BladeNight on', name: 'eventOn', desc: '', args: []);
  }
  ...
  String get locationNotPreciseTitle {
    return Intl.message(
      'Location not precise',
      name: 'locationNotPreciseTitle',
      desc: '',
      args: [],
    );
  }
