...
import '../map/widgets/map_overlays/track_only_overlay_widget.dart'
    show TrackOnlyOverlayWidget;
...
class _EventDataOverviewState extends ConsumerState<EventDataOverview>
  ...
  Widget build(BuildContext context) {
    ...
    if (ref.watch(locationProvider).trackingType == TrackingType.onlyTracking) {
      return const TrackOnlyOverlayWidget();
    } else {
      return Column(
