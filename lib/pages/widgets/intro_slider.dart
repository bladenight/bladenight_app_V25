  ...
  void didChangeDependencies() {
    ...
    slides.add(
      ContentConfig(
        ...
        styleTitle: titleStyle,
        description:
            'Im oberen Teil der Karte kann man sehen welche Strecke auf der Route man gefahren ist (↦7.4 km).\n'
            'Wieviel Prozent der Gesamtstrecke (51.3 %).\n'
            'Wie weit es bis zum Ziel ist ⇥7.1 km\n'
            'Auf dem Balken wird der Fortschritt und Position der Freunde und des Zuges angezeigt\n'
            '⏱ Σ Welche Durchfahrtzeit hat der Zug\n'
            '⇥ Wie lange dauert es bis zum Zugende\n'
            '📏 Wie lang ist der Zug von Anfang bis Ende (2.0km)\n'
            'Route: Name der aktuellen Route\n'
            'Length: Länge der Strecke\n'
            'Tracker - Anzahl der unterstützenden Teilnehmer (Tracker)\n',
        styleDescription: descriptionStyle,
        backgroundColor: CupertinoTheme.of(context).scaffoldBackgroundColor,
    ...
    slides.add(
      ContentConfig(
        title: 'Karte Detailinformationen',
        styleTitle: titleStyle,
        backgroundColor: CupertinoTheme.of(context).scaffoldBackgroundColor,
    ...
    slides.add(
      ContentConfig(
        ...
        description:
            ...
            'Es werden keinerlei persönliche Daten übermittelt, ausser der Nachricht mit dem Dienst deiner Wahl,'
            ' die du selbst mit dem Code an den Freund schickst',
        styleDescription: descriptionStyle,
