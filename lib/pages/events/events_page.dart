...
Widget _listTile(
  ...
  return GestureDetector(
    ...
    child: Container(
      decoration: BoxDecoration(
          color: startState == EventStartState.eventActual
              ? CupertinoTheme.of(context).primaryContrastingColor
              : odd
...
Widget _summarizeListTile(BuildContext context, int participants,
    int eventsCancelled, int eventsFinished, int eventsPlanned, String header) {
  //mark old actual an new events
  Color? color;
  return Container(
    decoration: BoxDecoration(
          ...
          child: Column(
            ...
            children: [
              ...
              DataLeftRightContent(
                  ...
                  rightWidget: SizedBox()),
              DataLeftRightContent(
                  descriptionLeft: Localize.of(context).pending,
                  descriptionRight: eventsPlanned.toString(),
                  rightWidget: SizedBox()),
              DataLeftRightContent(
