...
List<UserGpxPoint> _simplifyRadialDist(
  List<UserGpxPoint> points,
  double sqTolerance,
) {
  UserGpxPoint prevPoint = points[0];
  final List<UserGpxPoint> newPoints = [prevPoint];
  late UserGpxPoint point;
...
List<UserGpxPoint> _simplifyDouglasPeucker(
  List<UserGpxPoint> points,
  double sqTolerance,
) {
  final int last = points.length - 1;

  final List<UserGpxPoint> simplified = [points[0]];
...
List<UserGpxPoint> simplifyUserGpxPointList(
  List<UserGpxPoint> points, {
  double? tolerance,
