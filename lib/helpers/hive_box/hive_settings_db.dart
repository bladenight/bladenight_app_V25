...
class HiveSettingsDB {
  ...
  static Box get _locationHiveBox {
    return Hive.box(hiveBoxLocationDbName);
  }

  static Box get settingsHiveBox {
    return _hiveBox;
  }

  static Box get friendsHiveBox {
    return _hiveBox;
  }
  ...
  static const String _firstStart2508Key = 'firstStartVersion2508Key';

  ///get firstStart
  static bool get firstStart2508 {
    return _hiveBox.get(_firstStart2508Key, defaultValue: true);
  }

  ///set if  setFirstStart
  static void setFirstStart2508(bool val) {
    _hiveBox.put(_firstStart2508Key, val);
  }
  ...
  ///Set if Bladeguard has geofencing enabled
