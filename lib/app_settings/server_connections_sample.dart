...
//in debugmode set local
import 'package:flutter/foundation.dart';

bool localTesting = false && kDebugMode;
//in debugmode set bnserver
bool remoteTesting = false && kDebugMode;
bool riverPodDebugLog = false && kDebugMode;

const String sentryDSN = 'https://.....';
...
const String defaultBladenightRestApiServerLink =
    'https://bladenight.app/rest/api';
...
const int realtimeSubscriptionId = 3589978069;

const String bladeGuardPassword = 'passwd';
const String bladeGuardLeaderPassword = 'leader_pass_wd';
