  ...
  Future<bool> startTracking(TrackingType trackingType) async {
    try {
      ...
      var locationIsPrecise =
          await LocationPermissionDialog().checkLocationAccuracy();
      if (!locationIsPrecise && context.mounted) {
        await QuickAlert.show(
            context: context,
            type: QuickAlertType.confirm,
            showCancelBtn: false,
            confirmBtnColor: Colors.orange,
            title: Localize.current.locationNotPrecise,
            text: Localize.current.locationNotPreciseTitle,
            onConfirmBtnTap: () {
              rootNavigatorKey.currentState?.pop();
            },
            confirmBtnText: Localize.current.understand);
      }
      //if (kIsWeb) return false;
